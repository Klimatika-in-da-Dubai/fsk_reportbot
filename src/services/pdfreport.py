...
class pdfGenerator():
    ...
    def bef_aft_slide(self, work_name: str, node_name: str):
        ...
        textobject.setFillColor("#FFFFFF")
        textobject.setTextOrigin(Indent.get_x(), PDF_HEIGHT - Indent.get_y() - HEDING_FONT_SIZE * 4)
        textobject.textLine(text="до")
        textobject.setTextOrigin(860 + Indent.get_x(), PDF_HEIGHT - Indent.get_y() - HEDING_FONT_SIZE * 4)
